...
?>
    ...
    <body>
        ...
        <div id="footer">
            <strong><a href="http://lasunigeria.edu.ng">LAGOS STATE UNIVERSITY HUMAN RESOURCE MANAGEMENT</a></strong> &copy; by <a href="http://www.handsonlabs.org" target="_blank">OWOEYE OLUWATOBI</a>. 2008 - <?php echo $currentYear?> All rights reserved.
        </div> <!-- footer --> 
